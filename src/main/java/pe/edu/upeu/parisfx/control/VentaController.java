...
import pe.edu.upeu.parisfx.dto.ModeloDataAutocomplet;
import pe.edu.upeu.parisfx.dto.SessionManager;
import pe.edu.upeu.parisfx.modelo.VentCarrito;
...
public class VentaController {
    ...
    private void registarPCarrito(){
        try {
            ...
            lastProducto = null;  // Resetear la selección de autocompletado

            // Deshabilitar el botón si es necesario
            btnRegCarrito.setDisable(true);
    ...
    public void registrarVenta(){
        ...
        try {
            ...
            txtIgv.clear();
            txtImporteT.clear();
            btnRegVenta.setDisable(true); // Deshabilitar el botón si es necesario
